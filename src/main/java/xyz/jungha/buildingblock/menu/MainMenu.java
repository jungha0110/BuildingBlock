...
public class MainMenu extends AbstractMenu {
    ...
    public static Inventory getInventory(ChunkService chunkService) {
        ...
        inv.setItem(11, createItem(Material.COMPASS, "<green>멤버", List.of(" ", "<white>:left_m: <gray>클릭 시 멤버 메뉴창이 열립니다.")));
        inv.setItem(15, createItem(Material.BARRIER, "<red>건차 회수", List.of(" ", "<white>:left_m: <gray>클릭 시 건차를 회수합니다.")));
        return inv;
    }
}